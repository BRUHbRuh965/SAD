...
local tab5 = win:Tab("Players", "http://www.roblox.com/asset/?id=242655952")
...
tab2:Toggle("Melee", "", function(t)
    melee = t

    end)
    
tab2:Toggle("Defense", "", function(t)
    Defense = t
    end)
tab2:Toggle("Sword", "", function(t)
    sword = t
    end)
tab2:Toggle("Gun", "", function(t)
    Gun = t
    end)
tab2:Toggle("BloxFruit", "", function(t)
    BloxFruit = t
    end)
